...
class API_case(Basics_case):
    ...
    def test_case(self):
        ...
        try:
                ...
                old_fatRate_list = [22, 22, 25, 22, 21]  # 创造在数据库里面已经有的体脂率的数据，int类型或是str

                corr_time_list = [259600, 260000, 270000, 280000, 290000]  # 数据创建的时间 int类型

                fatRate = 18  # 称重得到的体脂率  int类型

                corr_Fatrate = 18  # 被修改后的体脂率   int类型
