...
from my_python_code.mysql.mysql_multiprocess import local_mysql
...
if __name__ == '__main__':
    a = orm_to_mysql(local_mysql())
    print(a.table('web_platform_course').select('name', subject_show_id=1).all())
    print(a.table('web_platform_course').select('name', subject_show_id=1).one())
