...
Complete_path=r'F:/Test_Platform_Code_refactoring'
my_api_case_log=r'F:\Test_Platform_Code_refactoring\my_python_code\my_log\my_api_case_log.txt'   #记录LOG的保存地址
