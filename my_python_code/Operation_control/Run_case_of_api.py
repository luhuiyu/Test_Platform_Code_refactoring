    ...
    for x in task_queue['task_state_list']:
        ...
        # print(report_data['pass_tate'],type(report_data['pass_tate']))
         if report_data['pass_tate']==100:
             ...
             report_result=0
         now_report=my_report(user_name=web_user_name,report_data=report_data,report_result=report_result,uuid=uuid.uuid4(),App_name=x[2],terminal_number=1,test_type=x[1],App_version=App_version).save()
