...
class get_api_case_form(forms.Form):
    ...
    api_name= forms.CharField(label='接口名(api_name)',max_length=200,widget=widgets.TextInput(attrs={'id': 'api_name', 'name': 'api_name','class':'form-control api_case','width':'10%','text-overflow':'ellipsis','overflow':'hidden'}))
    api_case_name= forms.CharField(label='api_case_name',max_length=200,widget=widgets.TextInput(attrs={'id': 'api_case_name', 'name': 'api_case_name','class':'form-control api_case','width':'40%','text-overflow':'ellipsis','overflow':'hidden'}))
